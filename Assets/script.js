...
function colorCode() {
  ...
  if (now > 18) {
    $("#comment6pm").addClass("past");
  } else if (now >= 18 && now < 19) {
    $("#comment6pm").addClass("present");
  } else if (now < 18) {
    $("#comment6pm").addClass("future");
  }
  if (now > 19) {
    $("#comment7pm").addClass("past");
  } else if (now >= 19 && now < 20) {
    $("#comment7pm").addClass("present");
  } else if (now < 19) {
    $("#comment7pm").addClass("future");
  }
}
...
function sevenPM() {
  var input_textarea11 = document.querySelector("#comment7pm");
  var output_div11 = document.querySelector("#comment7pm");
  var save_button11 = document.querySelector("#button7pm");
